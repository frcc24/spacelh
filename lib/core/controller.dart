...
// import 'package:spacelh/scoreboard.dart';
...
class Controller extends Component with HasGameRef<MyGame> {
  ...
  late PlayerSpaceShip player;

  //
  // Easy access to Image manipulation ofr the game engine
  late Images images;

  PlayerSpaceShip getSpaceship() {
    return player;
  }
  ...
  Future<void> init() async {
    ...
    _baseResolution = Vector2(400, 600);
    ...
    debugPrint('{controller} <resolution>: [${gameRef.size.x}, ${gameRef.size.y}], $_baseResolution, $_resolutionMultiplier');
    ...
    _joystick = JoystickComponent(
      ...
      background: CircleComponent(radius: 200, paint: backgroundPaint),
  ...
  void spawnNewPlayer() {
    ...
    PlayerBuildContext context = PlayerBuildContext()
      ..spaceShipType = SpaceShipEnum.playerSpaceShip
      ..joystick = _joystick
