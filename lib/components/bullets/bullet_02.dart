...
class Bullet02 extends Bullet {
  ...
  Bullet02(Vector2 position, Vector2 velocity)
  ...
  //
  // named constructor
  Bullet02.fullInit(Vector2 position, Vector2 velocity, Vector2? size, double? speed, int? health, int? damage)
  ...
  Future<void> onLoad() async {
    ...
    spriteSheet = SpriteSheet(
      image: await gameRef.images.load('bullet02.png'),
